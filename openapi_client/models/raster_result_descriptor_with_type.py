...
class RasterResultDescriptorWithType(BaseModel):
    """
    ...
    __properties = ["bbox", "dataType", "measurement", "resolution", "spatialReference", "time", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RasterResultDescriptorWithType:
        """Create an instance of RasterResultDescriptorWithType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RasterResultDescriptorWithType:
        """Create an instance of RasterResultDescriptorWithType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RasterResultDescriptorWithType.parse_obj(obj)

        _obj = RasterResultDescriptorWithType.parse_obj({
