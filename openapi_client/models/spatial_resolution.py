...
class SpatialResolution(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpatialResolution:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpatialResolution:
        """Create an instance of SpatialResolution from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpatialResolution.parse_obj(obj)

        _obj = SpatialResolution.parse_obj({
            "x": obj.get("x"),
            "y": obj.get("y")
        })
        return _obj
