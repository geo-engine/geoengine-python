...
class DerivedColorWithType(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DerivedColorWithType:
        """Create an instance of DerivedColorWithType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DerivedColorWithType:
        """Create an instance of DerivedColorWithType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DerivedColorWithType.parse_obj(obj)

        _obj = DerivedColorWithType.parse_obj({
