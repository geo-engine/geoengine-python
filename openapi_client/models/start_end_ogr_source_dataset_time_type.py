...
class StartEndOgrSourceDatasetTimeType(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StartEndOgrSourceDatasetTimeType:
        """Create an instance of StartEndOgrSourceDatasetTimeType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StartEndOgrSourceDatasetTimeType:
        """Create an instance of StartEndOgrSourceDatasetTimeType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StartEndOgrSourceDatasetTimeType.parse_obj(obj)

        _obj = StartEndOgrSourceDatasetTimeType.parse_obj({
