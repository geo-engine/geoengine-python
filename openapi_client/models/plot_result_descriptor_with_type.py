...
class PlotResultDescriptorWithType(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('plot', 'raster', 'vector'):
            raise ValueError("must be one of enum values ('plot', 'raster', 'vector')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PlotResultDescriptorWithType:
        """Create an instance of PlotResultDescriptorWithType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PlotResultDescriptorWithType:
        """Create an instance of PlotResultDescriptorWithType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PlotResultDescriptorWithType.parse_obj(obj)
