...
class OgrSourceTimeFormatCustom(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OgrSourceTimeFormatCustom:
        """Create an instance of OgrSourceTimeFormatCustom from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OgrSourceTimeFormatCustom:
        """Create an instance of OgrSourceTimeFormatCustom from a dict"""
        if obj is None:
            return None
