...
class PolygonSymbology(BaseModel):
    """
    PolygonSymbology
    """
    ...
    __properties = ["autoSimplified", "fillColor", "stroke", "text"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolygonSymbology:
        """Create an instance of PolygonSymbology from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PolygonSymbology:
        """Create an instance of PolygonSymbology from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolygonSymbology.parse_obj(obj)

        _obj = PolygonSymbology.parse_obj({
