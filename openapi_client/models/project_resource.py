...
class ProjectResource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectResource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectResource:
        """Create an instance of ProjectResource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProjectResource.parse_obj(obj)

        _obj = ProjectResource.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
