...
class DerivedNumber(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DerivedNumber:
        """Create an instance of DerivedNumber from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DerivedNumber:
        """Create an instance of DerivedNumber from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DerivedNumber.parse_obj(obj)
