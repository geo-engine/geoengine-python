...
class DatasetResource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatasetResource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatasetResource:
        """Create an instance of DatasetResource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatasetResource.parse_obj(obj)

        _obj = DatasetResource.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
