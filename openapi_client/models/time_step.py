...
class TimeStep(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TimeStep:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TimeStep:
        """Create an instance of TimeStep from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TimeStep.parse_obj(obj)

        _obj = TimeStep.parse_obj({
