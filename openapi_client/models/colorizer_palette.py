...
class ColorizerPalette(BaseModel):
    """
    ColorizerPalette
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ColorizerPalette:
        """Create an instance of ColorizerPalette from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ColorizerPalette:
        """Create an instance of ColorizerPalette from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ColorizerPalette.parse_obj(obj)

        _obj = ColorizerPalette.parse_obj({
