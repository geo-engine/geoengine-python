...
class GdalMetadataNetCdfCfWithType(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GdalMetadataNetCdfCfWithType:
        """Create an instance of GdalMetadataNetCdfCfWithType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GdalMetadataNetCdfCfWithType:
        """Create an instance of GdalMetadataNetCdfCfWithType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GdalMetadataNetCdfCfWithType.parse_obj(obj)

        _obj = GdalMetadataNetCdfCfWithType.parse_obj({
