...
class TimeStepWithType(BaseModel):
    """
    TimeStepWithType
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TimeStepWithType:
        """Create an instance of TimeStepWithType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TimeStepWithType:
        """Create an instance of TimeStepWithType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TimeStepWithType.parse_obj(obj)

        _obj = TimeStepWithType.parse_obj({
