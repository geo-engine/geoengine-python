...
OGRSOURCEDURATIONSPEC_ONE_OF_SCHEMAS = ["OgrSourceDurationSpecInfinite", "OgrSourceDurationSpecZero", "TimeStepWithType"]
...
class OgrSourceDurationSpec(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Union[OgrSourceDurationSpecInfinite, OgrSourceDurationSpecZero, TimeStepWithType]
    else:
        actual_instance: Any
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in OgrSourceDurationSpec with oneOf schemas: OgrSourceDurationSpecInfinite, OgrSourceDurationSpecZero, TimeStepWithType. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in OgrSourceDurationSpec with oneOf schemas: OgrSourceDurationSpecInfinite, OgrSourceDurationSpecZero, TimeStepWithType. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> OgrSourceDurationSpec:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into OgrSourceDurationSpec with oneOf schemas: OgrSourceDurationSpecInfinite, OgrSourceDurationSpecZero, TimeStepWithType. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into OgrSourceDurationSpec with oneOf schemas: OgrSourceDurationSpecInfinite, OgrSourceDurationSpecZero, TimeStepWithType. Details: " + ", ".join(error_messages))
        else:
            return instance
