...
COLORIZER_ONE_OF_SCHEMAS = ["ColorizerPalette", "ColorizerRgba", "LinearGradientWithType", "LogarithmicGradientWithType"]
...
class Colorizer(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Union[ColorizerPalette, ColorizerRgba, LinearGradientWithType, LogarithmicGradientWithType]
    else:
        actual_instance: Any
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in Colorizer with oneOf schemas: ColorizerPalette, ColorizerRgba, LinearGradientWithType, LogarithmicGradientWithType. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in Colorizer with oneOf schemas: ColorizerPalette, ColorizerRgba, LinearGradientWithType, LogarithmicGradientWithType. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Colorizer:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into Colorizer with oneOf schemas: ColorizerPalette, ColorizerRgba, LinearGradientWithType, LogarithmicGradientWithType. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Colorizer with oneOf schemas: ColorizerPalette, ColorizerRgba, LinearGradientWithType, LogarithmicGradientWithType. Details: " + ", ".join(error_messages))
        else:
            return instance
