...
class ProvenanceTests(unittest.TestCase):
    ...
    def test(self):
        with requests_mock.Mocker() as m:
            ...
            m.get('http://mock-instance/workflow/5b9508a8-bd34-5a1c-acd6-75bb832d2d38/provenance',
                  json=[{
                      "dataset": {
                          "type": "internal",
            ...
            self.assertEqual(provenance, [
                ProvenanceOutput(InternalDatasetId("36574dc3-560a-4b09-9d22-d5945f2b8093"),
                                 Provenance("Nasa Earth Observations, MODIS Vegetation Index Products",
