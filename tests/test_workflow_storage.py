...
class WorkflowStorageTests(unittest.TestCase):
    ...
    def test_storing_workflow_task(self):
        with requests_mock.Mocker() as m:
            m.post('http://mock-instance/anonymous', json={
                "id": "c4983c3e-9b53-47ae-bda9-382223bd5081",
                "project": None,
            ...
            m.post('http://mock-instance/datasetFromWorkflowTask/5b9508a8-bd34-5a1c-acd6-75bb832d2d38',
                   additional_matcher=lambda request: request.text == json.dumps({
                       "name": "Foo",
                       "description": "Bar",
                       "query": {
            ...
            task_status = ge.tasks.get_task_status(task_id)
